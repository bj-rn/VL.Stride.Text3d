// OpenType feature tags (DWRITE_FONT_FEATURE_TAG). Member names and FourCC values match
// the former SharpDX.DirectWrite.FontFeatureTag alias (extracted from SharpDX 4.2.0).

namespace VL.Stride.Text3d.Enums;

/// <summary>Typographic feature of text supplied by the font (used by the Typography text style).</summary>
